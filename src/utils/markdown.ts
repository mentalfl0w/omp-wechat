 ...
 *
 * WeChat doesn't render markdown, so AI responses are stripped of
 * formatting syntax before sending. Preserves newlines and content
 * structure; strips formatting markers.
 *
 * Ported from the official iLink SDK (corespeed-io/wechatbot,
 * media/markdown.ts, MIT).
 */
export function stripMarkdown(text: string): string {
  ...
  // Images: remove entirely (media is delivered as attachments instead)
